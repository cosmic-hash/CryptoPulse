        ...
        <div className="container mx-auto px-4 py-10 max-w-7xl">
          ...
          <div className="p-8 rounded-2xl bg-gray-900 border border-gray-700 shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <button onClick={openAddAlertModal} className="w-full mt-6 p-3 border-2 border-dashed rounded-xl border-blue-400 text-blue-400 hover:bg-blue-500 hover:text-black transition">
                + Create New Alert
              </button>
            </div>
          </div>
              ...
              <div className="fixed inset-0 bg-black/70 flex justify-center items-center p-4 z-50">
                <div className="bg-gray-900 p-6 rounded-2xl w-full max-w-md shadow-2xl">
                  ...
                  <div className="mb-4">
                    ...
                    <select value={formCoinAlert} onChange={(e) => setFormCoinAlert(e.target.value)} className="w-full p-2 rounded bg-gray-800 border border-gray-600 text-white">
                  ...
                  <div className="mb-6">
                    ...
                    <input type="number" min="-1" max="1" step="0.01" value={formThresholdAlert} onChange={(e) => setFormThresholdAlert(e.target.value)} className="w-full p-2 rounded bg-gray-800 border border-gray-600 text-white" />
                  </div>

                  <div className="flex justify-end gap-3">
                    <button onClick={() => setIsSentimentModalOpen(false)} className="px-4 py-2 rounded bg-gray-700 hover:bg-gray-600 text-white">
                      Cancel
                    </button>
                    <button onClick={handleSaveAlert} className="px-4 py-2 rounded bg-blue-500 hover:bg-blue-600 text-black font-bold">
                      Save
                    </button>
                  </div>
                </div>
